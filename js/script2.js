...
async function displayAlbums() {
  ...
  document.querySelectorAll(".card").forEach((item) => {
    item.addEventListener("click", async (event) => {
      ...
      loadPlaylist();
      let currentPlay = document
        .querySelector(".music-infos")
        .querySelector(".songName").innerText;
      let songNames = Array.from(
        document.querySelector(".songList").getElementsByClassName("songName")
  ...
  document.querySelectorAll(".play").forEach((item) => {
    item.addEventListener("click", async (event) => {
      ...
      document
        .querySelector(".songList")
        .getElementsByTagName("li")[0].style.backgroundColor = "black";
...
async function main() {
  ...
  currentSong.addEventListener("timeupdate", () => {
    document.querySelector(".passedTime").innerHTML = secondsToTime(
      currentSong.currentTime
    );
    document.querySelector(".totalDuration").innerHTML = secondsToTime(
    ...
    document.querySelector(".color").style.width =
  ...
  currentSong.addEventListener("volumechange", () => {
    ...
    document.querySelector(".circles").style.left =
      currentSong.volume * 100 + "%";

    document.querySelector(".colors").style.width =
      currentSong.volume * 100 + "%";
  });
